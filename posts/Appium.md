...
### ✔ APPIUM 이란
---
 - Appium은 UI 자동화를 지원하도록 설계된 오픈소스 소프트웨어
 - Selenium으로 웹 크롤링을 자동화하듯 에뮬레이터나 휴대전화에 연결하여 앱 UI요소들을 자동으로 조작할 수 있도록 하는 소프트웨어

### 🚩 APPIUM을 사용하게 된 이유
---
앱으로만 제공하고 있는 서비스를 이용하다보면, 이게 웹이면 참 조작이 쉬울텐데 앱이라서 그렇지 않은 부분이 많다는 것을 느낀다. 특히 업무에서 앱을 계속 쳐다보는 일이 생기다보니 이대로 진행하기보다는 앱 요소들의 조작을 자동화해서 좀 더 편하게 앱 내부를 살피고 싶다는 욕망이 생겼다. .👾 물론 합법적인 수준에서 과한 요청을 보내지 않고, 내가 원하는 정보만 얻을 수 있도록 구현하긴 했으나. . 불법으로 의심받을만한 여지가 있어 깃허브 레포지토리는 프라이빗으로 돌려두었다.
...
<div class="img-row">
    <img src = "/images/appium/inspector1.jpg" width = 100% />
    <img src = "/images/appium/inspector2.jpg" width = 100% />
<div>
