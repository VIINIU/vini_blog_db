중앙대학교 전자전기공학부 20223389 서유빈
`https://viniu.info`
`11e26@cau.ac.kr`
## Abstraction

MINI-V Android OS는 Qualcomm Chipset(Snapdragon 8 Gen 2) 기반의 안드로이드 기기(Xiaomi 13)에서 NPU를 활성화하는 워크로드를 Vendor/System Level에서 내장하여 구현한 Custom Android OS이다. 

## Background and Motivation

### 기존 Android Application AI Workload

![[Pasted image 20260901142854.png]]
...
![[Pasted image 20260901151429.png|262]]
...
![[Pasted image 20260901151709.png|611]]
...
![[Pasted image 20260901154616.png]]
...
예시 Application인 MINI-V Android Chat의 제작은 졸업으로 팀원으로 이름을 올리지 못한 유용민군의 도움을 받았다.
